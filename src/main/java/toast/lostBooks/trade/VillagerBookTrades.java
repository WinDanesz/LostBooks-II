...
public class VillagerBookTrades implements EntityVillager.ITradeList {
	...
	public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random) {
		...
		bookCost[0] = Math.max(1, Math.min(64, PropertyHelper.getInt(PropertyHelper.TRADING, "minBookCost")));
		bookCost[1] = Math.max(bookCost[0], Math.min(64, PropertyHelper.getInt(PropertyHelper.TRADING, "maxBookCost")));
